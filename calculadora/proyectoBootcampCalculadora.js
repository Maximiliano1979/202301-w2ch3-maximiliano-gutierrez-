...
const restar = (numero1, numero2) => {
    resultadoResta = (numero1 - numero2).toFixed(3);
...
const multiplicar = (numero1, numero2) => {
    resultadoMultiplicar = (numero1 * numero2).toFixed(3);
...
const dividir = (numero1, numero2) => {
    resultadoDividir = (numero1 / numero2).toFixed(3);
